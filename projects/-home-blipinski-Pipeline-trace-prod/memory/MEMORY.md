...
- [Schema v21 — n50](project_schema_v21_n50.md) — `qc_metrics.n50` INTEGER, **les 3 combos** (liquid CGFL+HCL ET solid CGFL), TSV cramino lu **par nom d'en-tête** (helper `read_last_line_by_header`, ≠ ses voisines qui lisent par position). Export entre Coverage et mVAF v1. Backfill 10/08/2026 : **couverture 100 %** (1471), médiane liquid 174 bp / solid 3804 bp. ⚠ dossier QC/Cramino à plat (14 fichiers : raréfiés + EPIC) → jamais de glob. ⚠ un n50 liquid élevé n'est PAS une erreur : 15 liquides ≥1000 bp, surtout des Bladder_Urine (matrice urinaire) — contrôler la cohérence entre réplicats, pas la valeur absolue
