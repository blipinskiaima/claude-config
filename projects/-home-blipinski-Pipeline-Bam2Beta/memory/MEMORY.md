...
- [Google Doc QC — Ratio N50/N75](gdoc-qc-ratio-n50.md) — document de restitution, 5 figures, accès API Docs v1 via credentials gspread (`includeTabsContent=true` obligatoire). Figures 1-2 refaites en **logique autosomes chr1-22** le 2026-08-12, ce qui les aligne sur les données `read_lengths.csv` des parties 5-6
