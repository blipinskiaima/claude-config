...
- Pipeline modules: MERGE, BETA (EPIC), BETA_28M (Loyfer + score mVAF v1.3), FRAG (v2 softclip-removed), CNV, ICHORCNA, IV, MVAF1_4 (transfo v1.4 retrospectif), bootstrap (R&D, raima:0.5.3), QC
